# Canonical URL Map — kafemashini.ch

Source of truth for URL verification. Every URL below MUST return HTTP 200 on the new site.
...
| `/produkt/saeco-royal-digital` | Saeco Royal Digital |
| `/produkt/delonghi-perfecta-esam-5400` | DeLonghi Perfecta ESAM 5400 |
| `/produkt/saeco-royal-office` | Saeco Royal Office |
| `/produkt/saeco-incanto-s-class-classic` | Saeco Incanto S-Class Classic |
...
| `/produkt/saeco-moltio` | Saeco Moltio |
| `/produkt/delonghi-cappuccino-esam-25452` | DeLonghi Cappuccino ESAM 25452 |
| `/produkt/saeco-talea-touch-plus` | Saeco Talea Touch Plus |
| `/produkt/delonghi-esam-04-110-b` | DeLonghi ESAM 04.110.B |
| `/produkt/delonghi-cappuccino-ecam-23-450` | DeLonghi Cappuccino ECAM 23.450 |
| `/produkt/delonghi-primadonna-s` | DeLonghi PrimaDonna S |
| `/produkt/delonghi-3500` | DeLonghi 3500 |
| `/produkt/saeco-talea-touch` | Saeco Talea Touch |
| `/produkt/delonghi-primadonna` | DeLonghi PrimaDonna |
...
| `/produkt/saeco-syntia` | Saeco Syntia |
| `/produkt/saeco-exprelia` | Saeco Exprelia |
| `/produkt/saeco-minuto-cappuccino-hd8763` | Saeco Minuto Cappuccino HD8763 |
| `/produkt/saeco-granbaristo` | Saeco GranBaristo |
| `/produkt/saeco-intelia-evo` | Saeco Intelia Evo |
| `/produkt/primadonna-avant-6700` | PrimaDonna Avant 6700 |
| `/produkt/saeco-talea-ring` | Saeco Talea Ring |
| `/produkt/delonghi-intensa-ecam-23210` | DeLonghi Intensa ECAM 23210 |
| `/produkt/saeco-incanto-deluxe` | Saeco Incanto Deluxe |
| `/produkt/saeco-primea-ring-plus` | Saeco Primea Ring Plus |
| `/produkt/saeco-xsmall` | Saeco XSmall |
...
| `/garantsiya.html` | Гаранция |
| `/serviz-na-kafe-mashini.html` | Сервиз на кафе машини |
| `/istoria_na_kafe_mashinite.html` | История на кафе машините |
| `/kafe_mashini.html` | Кафе машини |
| `/produkti.html` | Продукти |

## Info Pages without Extension (4)

| URL | Page Title |
|-----|-----------|
| `/biskvitki` | Бисквитки |
| `/cookie-policy` | Cookie Policy |
| `/zashtita-na-lichnite-danni` | Защита на личните данни |
| `/uslovia` | Условия |
...
| URL | Page Title |
|-----|-----------|
| `/produkti/instruktsii-za-upotreba` | Инструкции за употреба |
